...
void GLWindow2::on_mouse_down(GLWindow& win, CVD::ImageRef where,
...
pair<TooN::Vector<6>, TooN::Vector<6> > GLWindow2::GetMousePoseUpdate() {
  pair<TooN::Vector<6>, TooN::Vector<6> > result = make_pair(mvLeftPoseUpdate, mvMCPoseUpdate);
